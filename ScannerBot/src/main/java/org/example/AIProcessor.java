...
public class AIProcessor {
    ...
    public String getSummaryFromAI(String text) throws IOException {
        ...
        userMessage.put("content", "Это текст новости из мира киноиндустрии. Нужно сократить его так, чтобы оставшаяся основная информация связана с новостью и мнение было логически завершено. Просьба игнорировать рекламные предложения и все, что связано с Украиной: " + text);

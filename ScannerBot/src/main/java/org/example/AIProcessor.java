...
public class AIProcessor {
    ...
    public String getSummaryFromAI(String text) throws IOException {
        ...
        userMessage.put("content", "Весь текст следует сократить до 300 слов. Он содержит новость из киноиндустрии. Ты должен создать логически завершенную новость. В этом тексте могут встречаться рекламные предложения и информация, связанная с Украиной, проигнорируй их: " + text);

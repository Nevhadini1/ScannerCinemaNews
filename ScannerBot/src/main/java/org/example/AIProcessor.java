...
public class AIProcessor {
    ...
    public String getSummaryFromAI(String text) throws IOException {
        ...
        userMessage.put("content", "Это текст новости из мира киноиндустрии. Нужно сократить его так, чтобы оставшаяся основная информация связана с новостью и мнение было логически завершено,также длина редактируемого текста должна быть хотя бы 100 слов. Игнорируй рекламные предложения(LG Home Entertainmen)  и все, что связано с Украиной: " + text);

...
public class AIProcessor {
    ...
    public String getSummaryFromAI(String text) throws IOException {
        ...
        userMessage.put("content", "Это текст новости из мира киноиндустрии. Нужно сократить его так, чтобы оставшаяся основная информация связана с новостью и мнение было логически завершено,также длина редактируемого текста должна быть хотя бы 100 слов и концовка текста всегда заканчивалась законченным предложением: " + text);
